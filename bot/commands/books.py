...
def take_book_init(update, context):
    context.bot.send_message(chat_id=update.message.chat_id, text="Введите номер книги чтобы зарегистрировать ее на вас:")
...
def register_taking_book(update, context):
    try:
        ...
        print(e)
        context.bot.send_message(chat_id=update.message.chat_id, text="Введите номер книги правильно или нажмите /cancel")
        return States.REGISTER_BOOK_TAKING
